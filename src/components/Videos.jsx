        ...
        <VStack w={'full'}>
            ...
            <VStack alignItems={"flex-start"} p={"8"} w={'full'} overflow={'auto'}>
                <Heading>
                    ...
                    <Text>
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Suscipit ducimus maxime nobis, est nemo itaque sed earum debitis at rem error pariatur doloremque eos laudantium quibusdam ea sapiente magnam atque! Ab, exercitationem? Natus nesciunt accusamus repellat dolorem, dignissimos maxime eaque quae distinctio perferendis asperiores facere, porro, debitis iure sequi voluptatum nulla obcaecati odio facilis. Quibusdam nisi nesciunt ratione aliquid modi voluptatum neque optio voluptatem impedit debitis eligendi ex facere tenetur rerum totam, et tempore consequatur assumenda dolorum velit ad vel!
                    </Text>
                
            </VStack>
        </VStack>

        <VStack width={['full', 'xl']} alignItems={'stretch'}
        p={"8"}
        spacing={'8'}
        overflowY={'auto'}>
            {
